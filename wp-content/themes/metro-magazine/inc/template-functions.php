    ...
    echo '<div class="footer-b">';
        echo '<div class="container">'; 
            echo '<div class="site-info">';
                ...
                esc_html_e( '&nbsp;', 'metro-magazine' );
                printf( esc_html__( '%s', 'metro-magazine' ), '<a href="'. esc_url( __( 'http://renaissancemensa.com/', 'metro-magazine' ) ) .'" target="_blank">'. esc_html__( 'RENAISSANCE SA. ', 'metro-magazine' ) .'</a>' );
